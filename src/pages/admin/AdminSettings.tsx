    ...
    <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         ...
         <div className="md:col-span-1 space-y-2">
            <NavButton icon={BadgeDollarSign} label="Monetization" active />
            <NavButton icon={ShieldCheck} label="Account Security" />
            <NavButton icon={Globe} label="Public Experience" />
            <NavButton icon={Bell} label="Alert Triggers" />
            <NavButton icon={Server} label="Infrastructure" />
         ...
         <div className="md:col-span-2 space-y-10">
            ...
            <div className="p-4 bg-rose-500/5 border border-rose-500/10 rounded-xl flex gap-4">
               ...
               <div className="space-y-1">
                  ...
                  <Button variant="outline" size="sm" className="border-rose-500/20 text-rose-500 hover:bg-rose-500/20 text-[10px] uppercase font-bold">Flush Platform Cache</Button>
               </div>
            </div>
         </div>
      </div>
...
function NavButton({ icon: Icon, label, active }: any) {
  return (
    <button className={cn(
      ...
      active 
        ? "bg-amber-500 text-[#0F1729] shadow-lg shadow-amber-500/20" 
